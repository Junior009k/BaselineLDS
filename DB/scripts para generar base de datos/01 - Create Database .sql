...
/****** Object:  Database [USER]    Script Date: 05/06/2024 8:16:15 ******/
CREATE DATABASE [USER]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'[USER]', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL16.SERVIDOR\MSSQL\DATA\[USER].mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'[USER]_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL16.SERVIDOR\MSSQL\DATA\[USER]_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
